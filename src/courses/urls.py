...
urlpatterns = [
    ...
    path('parts/detail/<int:pk>/', views.course_part_detail_view, name='coursepart_detail'),
    path('parts/create/', views.course_part_create_view, name='coursepart_create'),
    path('parts/create/<int:course_id>/', views.course_part_create_with_course_view, name='coursepart_create_with_course'),
    path('parts/update/<int:pk>/', views.course_part_update_view, name='coursepart_update'),
    path('parts/delete/<int:pk>/', views.course_part_delete_view, name='coursepart_delete'),

    # CourseTopic views
    path('topics/', views.course_topic_list_view, name='coursetopic_list'),
    path('topics/detail/<int:pk>/', views.course_topic_detail_view, name='coursetopic_detail'),
    path('coursetopics/create/<int:part_id>/', views.course_topic_create_with_course_part_view, name='coursetopic_create_with_coursepart'),
    path('topics/create/', views.course_topic_create_view, name='coursetopic_create'),
    path('topics/update/<int:pk>/', views.course_topic_update_view, name='coursetopic_update'),
    path('topics/delete/<int:pk>/', views.course_topic_delete_view, name='coursetopic_delete'),
